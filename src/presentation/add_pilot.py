...
"""
Class: Add_pilot_view

This class represents the GUI window for adding a new pilot.

Methods:
- setup(self): Sets up the GUI elements and layout.
- on_window_close(self): Handles the window close event.
- add_pilot(self): Handles the process of adding a new pilot.
...
"""
class Add_pilot_view(tk.Toplevel):
    ...
    def setup(self):
        ...
        self.create_heading["text"] = "Create new pilot"
        ...
        self.entry_email.place(x=400, y=180, width=300, height=50)

        self.label_age = tk.Label(self, bg="lightblue")
        ft = tkFont.Font(family='Times', size=18)
        self.label_age["font"] = ft
        self.label_age["fg"] = "#333333"
        self.label_age["justify"] = "left"
        self.label_age["text"] = "Age:"
        self.label_age.place(x=100, y=340, width=250, height=50)

        self.entry_age = tk.Entry(self)
        self.entry_age["borderwidth"] = "1px"
        ft = tkFont.Font(family='Times', size=18)
        self.entry_age["font"] = ft
        self.entry_age["fg"] = "#333333"
        self.entry_age["justify"] = "center"
        self.entry_age["text"] = ""
        self.entry_age.place(x=400, y=340, width=300, height=50)
        ...
        self.entry_phone.place(x=400, y=260, width=300, height=50)
        ...
        self.label_phone.place(x=100, y=260, width=250, height=50)
    ...
    def add_passenger(self):
        try:
            ...
            if age >= 25:
                pilot = Pilot(self.entry_name.get(), age, self.entry_email.get(), self.entry_phone.get())
                if self.master.app.pilot_dao.insert(pilot):
